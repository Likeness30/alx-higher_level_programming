#!/usr/bin/python3
""" A module that defines the test case for the Square class """
import unittest
...
class TestSquareMethods(unittest.TestCase):
    """ Represent the test Square class """
    ...
    def test_new_square_with_all_attrs(self):
    ...
    def test_str(self):
        ...
        new = Square(4, 1, 2, 3)
        self.assertEqual(str(new), "[Square] (3) 1/2 - 4")
    ...
    def test_to_dictionary(self):
        ...
        new = Square(2, 3, 4)
        expected = {'id': 1, 'size': 2, 'x': 3, 'y': 4}
        self.assertEqual(new.to_dictionary(), expected)
    ...
    def test_incorrect_amount_attrs_1(self):
        """Test error raised with incorrect number of args passed"""
        with self.assertRaises(TypeError):
